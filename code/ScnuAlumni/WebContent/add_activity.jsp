...
<body>
	...
	<a href="add_activity.jsp" class="weui-btn weui-btn_mini weui-btn_primary"><h3>发起活动</h3></a>
	<a href="my_activity.jsp" class="weui-btn_mini weui-btn weui-btn_plain-primary">我的活动</a>
    </div>
<hr/>
	<div>
		<br />
		<h2 class="weui-form-preview__btn weui-form-preview__btn_primary">新增活动</h2>
	</div>
